...
# 사용 예시
API_KEY = 'HgoM8YxJ5DZwJXaVRZ87JEEeGpmWDSAXGSzxGeCsM25tqbi6xPHDTT2fMXQFt9bR'  # 여기에 자신의 API 키를 입력하세요.
API_SECRET = '8t03t3Fa1GQZCD2f99r3HEE9GYVeXNhS4FyjZpCVPTbGofmoPYATilUCoXWJKixf'  # 여기에 자신의 API 시크릿 키를 입력하세요.
